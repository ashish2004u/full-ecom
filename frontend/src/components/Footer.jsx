...
const Footer = () => {
  ...
  const uniqueCategories = [...new Set(category.map((item) => item.category))];

  return (
    <footer className="bg-gray-50 text-gray-300 px-6 sm:px-12 pt-14 pb-6 mt-16">
    ...
    <div className=" mx-auto sm:px-6 lg:px-8 ">
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Style squad</p>
    </div>
</section>
    </footer>
  );
